...
class AVLTree {
 private:
  ...
  void rotate(Node* node, Node* oppositeNode, int targetHeight, bool right,
              bool dummy = false);
  void rotate2(Node* node, Node* oppositeNode, int targetHeight, bool right,
               bool dummy = false);
 ...
 public:
  AVLTree(long long maxSize, bytes<Key> secretkey, Bid& rootKey,
  ...
  Bid insert(Bid rootKey, unsigned long long& pos, Bid key, string value,
             int& height, Bid lastID, bool isDummyIns = false);
  Bid insert2(Bid rootKey, unsigned long long& pos, Bid key, string value,
              int& height, Bid lastID, bool isDummyIns = false);
  Bid searchInsert(Bid rootKey, unsigned long long& pos, Bid key, string& value,
                   int& height, Bid lastID, bool isDummyIns = false);

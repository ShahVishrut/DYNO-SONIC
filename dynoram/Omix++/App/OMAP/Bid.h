...
class Bid {
 public:
  ...
  static signed char CTcmp(byte_t lhs, byte_t rhs) {
    ...
    signed char is_less_than = (signed char)-(
        overflowing_iff_lt >> 15);  // -1 if self < other, 0 otherwise.
    signed char is_greater_than =
        (signed char)(overflowing_iff_gt >>
                      15);  // 1 if self > other, 0 otherwise.
